...
<head>
    ...
    <x-seo
        ...
        keywords="school bus GPS tracking software india, student transport management software, school transport ERP, school bus tracking system india, real-time school bus tracking, institute transport software, route optimization school bus, school vehicle tracking system, student bus boarding management, parent bus alert system whatsapp, school transport management system, EduNex ERP transport, school bus live tracking parent app, gps school bus tracking india"
    />
...
<section class="border-top py-5 text-center" style="border-color: var(--border) !important; background: #F1F5F9;">
    <div class="container py-5">
        ...
        <p class="mx-auto text-muted mb-4" style="max-width: 600px;">Get started with EduNex ERP today. Provide live tracking to parents, optimize route planning, and keep children safe throughout their commute.</p>
