        ...
        <div class="card border-0 shadow-sm rounded-4 p-4">
            <form action="{{ route('tests.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="title" class="form-control form-control-lg rounded-3 @error('title') is-invalid @enderror" value="{{ old('title') }}" placeholder="e.g. Mid-Term Physics Exam" required>
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="date" name="test_date" class="form-control form-control-lg rounded-3 @error('test_date') is-invalid @enderror" value="{{ old('test_date') }}" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="total_marks" class="form-control form-control-lg rounded-3 @error('total_marks') is-invalid @enderror" value="{{ old('total_marks', 100) }}" min="1" required>
                ...
                <div class="mb-5">
                    ...
                    <textarea name="description" class="form-control form-control-lg rounded-3 @error('description') is-invalid @enderror" rows="3" placeholder="Chapters to cover, rules, etc...">{{ old('description') }}</textarea>
                    @error('description') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>

                <div class="text-end">
                    <a href="{{ route('tests.index') }}" class="btn btn-light btn-lg rounded-pill px-4 me-2 fw-semibold">Cancel</a>
                    <button type="submit" class="btn btn-primary-glow btn-modern btn-lg px-5">Publish Test <i class="fas fa-paper-plane ms-2"></i></button>
                </div>
            </form>
        </div>
    </div>
