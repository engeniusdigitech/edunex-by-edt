...
@section('title', 'Add Question to Bank')
@section('content')
<style>
...
<div class="qb-form-header">
    <div style="position:relative;z-index:2;display:flex;align-items:center;gap:14px;">
        ...
        <div>
            ...
            <h2 style="font-size:1.4rem;font-weight:800;color:#fff;margin:0;letter-spacing:-.5px;">Add New Question</h2>
        </div>
    </div>
</div>
...
<div class="row g-4">
    <div class="col-lg-8">
        <div class="qb-form-card">
            ...
            <div class="qb-body">
                <form action="{{ route('question-bank.store') }}" method="POST" id="qbForm">
                    @csrf
                    ...
                    <div class="mb-3 qb-field">
                        ...
                        <textarea name="question" class="form-control @error('question') is-invalid @enderror" rows="3" placeholder="Type the question here..." required>{{ old('question') }}</textarea>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6 qb-field">
                            ...
                            <select name="correct_option" id="correctSelect" class="form-select" required>
                                ...
                                <option value="b" {{ old('correct_option','b')=='b'?'selected':'' }}>B</option>
                        ...
                        <div class="col-md-6 qb-field">
                            ...
                            <input type="number" name="marks" class="form-control" value="{{ old('marks',1) }}" min="1" max="100" required>
                        </div>
                    </div>

                    <div class="mb-4 qb-field">
                        <label>Explanation (shown to students after exam if review is enabled)</label>
                        <textarea name="explanation" class="form-control" rows="2" placeholder="Explain why this answer is correct...">{{ old('explanation') }}</textarea>
                    </div>

                    <div class="d-flex align-items-center gap-3 flex-wrap">
                        <button type="submit" class="qb-submit-btn"><i class="fas fa-save"></i> Save Question</button>
                        <button type="submit" name="add_another" value="1" class="qb-submit-btn" style="background:linear-gradient(135deg,#059669,#0D9488);box-shadow:0 4px 20px rgba(5,150,105,.3);"><i class="fas fa-plus"></i> Save & Add Another</button>
