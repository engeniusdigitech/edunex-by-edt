...
<div class="card border-0" style="background: linear-gradient(135deg, #0F172A, #1E293B);">
    <div class="card-body p-5 text-white">
        ...
        <p class="text-white opacity-75 fs-5 mb-0">Use the sidebar to manage onboarded institutes, oversee global metrics, and configure subscription plans running on the EduCore engine.</p>
    </div>
</div>
@endsection
