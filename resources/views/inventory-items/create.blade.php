...
<div class="f-hdr d-flex justify-content-between align-items-center flex-wrap gap-3">
    <div style="position:relative;z-index:2;">
        ...
        <h2 style="font-size:1.5rem;font-weight:800;color:#fff;margin:6px 0 0;letter-spacing:-.5px;">Add New Stock Item</h2>
    </div>
    <div style="position:relative;z-index:2;">
                        ...
                        <div class="p-3 bg-light rounded-4 border border-light-subtle">
                            <div class="d-flex gap-3 align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    <label for="available_qty" class="form-label fw-bold text-dark mb-1" style="font-size:.85rem;">Initial Stock Quantity <span class="text-danger">*</span></label>
