...
.btn-save{background:linear-gradient(135deg,#4F46E5,#7C3AED);color:#fff;border:none;padding:12px 24px;border-radius:10px;font-size:.85rem;font-weight:500;display:inline-flex;align-items:center;gap:8px;box-shadow:0 4px 15px rgba(79,70,229,.35);transition:all .2s;text-decoration:none;cursor:pointer;}
...
<div class="f-hdr d-flex justify-content-between align-items-center flex-wrap gap-3">
    <div style="position:relative;z-index:2;">
        ...
        <h2 style="font-size:1.5rem;font-weight:500;color:#fff;margin:6px 0 0;letter-spacing:-.5px;">Edit Stock Item: {{ $inventoryItem->name }}</h2>
    </div>
    <div style="position:relative;z-index:2;">
    ...
    <div class="col-lg-10">
        <div class="form-card p-4 p-md-5">
            <form action="{{ route('inventory-items.update', $inventoryItem) }}" method="POST">
                ...
                <h5 class="fw-medium mb-4 text-dark" style="letter-spacing:-.3px;"><i class="fas fa-edit me-2 text-indigo" style="color:#4F46E5;"></i> Basic Information</h5>
                ...
                <div class="p-4 bg-light rounded-4 border border-light-subtle">
                    <div class="d-flex gap-3 align-items-start mb-4">
                        ...
                        <div>
                            <h5 class="fw-medium mb-1 text-dark" style="font-size:1rem;">Manual Stock Level Adjustment</h5>
                    ...
                    <div class="row g-4">
                        <div class="col-md-4">
                            <label for="adjust_qty" class="form-label fw-medium text-dark" style="font-size:.8rem;">Adjustment Quantity</label>
                        ...
                        <div class="col-md-4">
                            <label for="adjust_type" class="form-label fw-medium text-dark" style="font-size:.8rem;">Adjustment Action</label>
                        ...
                        <div class="col-md-4">
                            <label for="adjust_reason" class="form-label fw-medium text-dark" style="font-size:.8rem;">Reason / Reference</label>
