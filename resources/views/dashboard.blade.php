...
<div class="row g-3 mb-4">
        ...
        <div class="card border-0 h-100" style="border-radius:16px;box-shadow:0 4px 20px rgba(79,70,229,0.08);">
            <div class="card-body p-3">
                <div class="d-flex align-items-center justify-content-between mb-2">
                    <span class="text-uppercase fw-bold text-muted" style="font-size:0.62rem;letter-spacing:1px;">Students</span>
                    <div class="rounded-2 d-flex align-items-center justify-content-center" style="width:30px;height:30px;background:rgba(79,70,229,0.1);color:#4F46E5;font-size:0.75rem;"><i class="fas fa-users"></i></div>
                </div>
    ...
    <div class="col-6 col-md-4 col-xl-2">
        <div class="card border-0 h-100" style="border-radius:16px;box-shadow:0 4px 20px rgba(16,185,129,0.08);">
            <div class="card-body p-3">
                <div class="d-flex align-items-center justify-content-between mb-2">
                    <span class="text-uppercase fw-bold text-muted" style="font-size:0.62rem;letter-spacing:1px;">Batches</span>
                    <div class="rounded-2 d-flex align-items-center justify-content-center" style="width:30px;height:30px;background:rgba(16,185,129,0.1);color:#10B981;font-size:0.75rem;"><i class="fas fa-layer-group"></i></div>
                </div>
    ...
    <div class="col-6 col-md-4 col-xl-2">
        <div class="card border-0 h-100" style="border-radius:16px;box-shadow:0 4px 20px rgba(245,158,11,0.08);">
            <div class="card-body p-3">
                <div class="d-flex align-items-center justify-content-between mb-2">
                    <span class="text-uppercase fw-bold text-muted" style="font-size:0.62rem;letter-spacing:1px;">Revenue</span>
                    <div class="rounded-2 d-flex align-items-center justify-content-center" style="width:30px;height:30px;background:rgba(245,158,11,0.1);color:#F59E0B;font-size:0.75rem;"><i class="fas fa-wallet"></i></div>
                </div>
                <h2 class="fw-black mb-0" style="color:#0F172A;font-size:1.3rem;">₹{{ number_format($monthlyRevenue, 0) }}</h2>
    ...
    <div class="col-6 col-md-4 col-xl-2">
        <div class="card border-0 h-100" style="border-radius:16px;box-shadow:0 4px 20px rgba(236,72,153,0.08);">
            <div class="card-body p-3">
                <div class="d-flex align-items-center justify-content-between mb-2">
                    <span class="text-uppercase fw-bold text-muted" style="font-size:0.62rem;letter-spacing:1px;">Staff</span>
                    <div class="rounded-2 d-flex align-items-center justify-content-center" style="width:30px;height:30px;background:rgba(236,72,153,0.1);color:#EC4899;font-size:0.75rem;"><i class="fas fa-user-tie"></i></div>
                </div>
    ...
    <div class="col-6 col-md-4 col-xl-2">
        <div class="card border-0 h-100" style="border-radius:16px;box-shadow:0 4px 20px rgba(99,102,241,0.08);">
            <div class="card-body p-3">
                <div class="d-flex align-items-center justify-content-between mb-2">
                    <span class="text-uppercase fw-bold text-muted" style="font-size:0.62rem;letter-spacing:1px;">Homework</span>
                    <div class="rounded-2 d-flex align-items-center justify-content-center" style="width:30px;height:30px;background:rgba(99,102,241,0.1);color:#6366F1;font-size:0.75rem;"><i class="fas fa-book-open"></i></div>
                </div>
    ...
    <div class="col-6 col-md-4 col-xl-2">
        <div class="card border-0 h-100" style="border-radius:16px;box-shadow:0 4px 20px rgba(239,68,68,0.08);">
            <div class="card-body p-3">
                <div class="d-flex align-items-center justify-content-between mb-2">
                    <span class="text-uppercase fw-bold text-muted" style="font-size:0.62rem;letter-spacing:1px;">Tests</span>
                    <div class="rounded-2 d-flex align-items-center justify-content-center" style="width:30px;height:30px;background:rgba(239,68,68,0.1);color:#EF4444;font-size:0.75rem;"><i class="fas fa-file-alt"></i></div>
                </div>
    ...
    <div class="col-lg-8">
        <div class="card border-0" style="border-radius:16px;box-shadow:0 4px 20px rgba(0,0,0,0.04);">
            <div class="card-header bg-white border-bottom-0 pt-4 pb-0 px-4 d-flex justify-content-between align-items-center">
                ...
                <span class="badge rounded-pill px-3 py-2 fw-semibold" style="background:#EEF2FF;color:#4338CA;font-size:0.7rem;">₹{{ number_format($monthlyRevenue, 0) }} this month</span>
            </div>
            ...
            <div class="card-body p-4 d-flex flex-column align-items-center justify-content-center">
                ...
                <div style="position:relative;width:130px;height:130px;margin-bottom:16px;">
                    ...
                    <div style="position:absolute;inset:0;display:flex;flex-direction:column;align-items:center;justify-content:center;">
                        <span class="fw-black" style="font-size:1.7rem;color:#{{ $todayAttendancePct >= 75 ? '10B981' : 'EF4444' }};">{{ $todayAttendancePct }}%</span>
                ...
                <div class="d-flex gap-4 text-center mt-1">
                    ...
                    <div>
                        <div class="fw-bold text-danger" style="font-size:1.1rem;">{{ $todayTotal - $todayPresent }}</div>
                ...
                <div class="text-center py-3">
                    ...
                    <a href="{{ route('attendance.index') }}" class="btn btn-sm btn-primary mt-3 rounded-pill">Mark Now</a>
                    @endif
                </div>
                @endif
            </div>
    ...
    <div class="col-lg-4">
        <div class="card border-0 h-100" style="border-radius:16px;box-shadow:0 4px 20px rgba(0,0,0,0.04);">
            <div class="card-header bg-white border-bottom-0 pt-4 pb-2 px-4 d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('payments.index') }}" class="text-primary fw-semibold" style="font-size:0.72rem;">View all</a>
            </div>
            <div class="card-body p-0">
                ...
                <div class="d-flex align-items-center px-4 py-2 border-bottom" style="border-color:#F8FAFC!important;">
                    ...
                    <div class="flex-grow-1 min-w-0">
                        <div class="fw-semibold text-dark text-truncate" style="font-size:0.8rem;">{{ $payment->student->name ?? '—' }}</div>
                        <div class="text-muted" style="font-size:0.68rem;">{{ $payment->payment_date->format('d M Y') }}</div>
                    </div>
                    <div class="fw-bold text-success ms-2" style="font-size:0.82rem;white-space:nowrap;">₹{{ number_format($payment->amount_paid, 0) }}</div>
                </div>
                @empty
...
@if($noAttendanceToday > 0)
<div class="alert border-0 d-flex align-items-center gap-3 mb-0" style="background:#FEF3C7;border-radius:14px;padding:14px 20px;">
    <i class="fas fa-exclamation-triangle text-warning fs-5"></i>
    <div>
        <span class="fw-bold text-dark" style="font-size:0.88rem;">Attendance not marked for {{ $noAttendanceToday }} student{{ $noAttendanceToday > 1 ? 's' : '' }} today.</span>
        <a href="{{ route('attendance.index') }}" class="text-primary fw-semibold ms-2" style="font-size:0.82rem;">Mark attendance →</a>
    </div>
</div>
@endif
