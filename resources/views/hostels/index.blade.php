...
.h-tag{font-size:.7rem;font-weight:700;padding:4px 10px;border-radius:50px;text-transform:uppercase;letter-spacing:.5px;}
...
<div class="h-hdr d-flex justify-content-between align-items-center flex-wrap gap-3">
    <div style="position:relative;z-index:2;">
        <span style="font-size:.7rem;font-weight:700;color:#67E8F9;text-transform:uppercase;letter-spacing:1px;"><i class="fas fa-hotel me-1"></i> Boarding &amp; Residence</span>
        <h2 style="font-size:1.5rem;font-weight:800;color:#fff;margin:6px 0 0;letter-spacing:-.5px;">Hostel Blocks</h2>
    </div>
    <div style="position:relative;z-index:2;">
    ...
    @forelse($hostels as $hostel)
        <div class="col-md-6 col-lg-4">
            <div class="h-card p-4">
                ...
                <h4 style="font-size:1.15rem;font-weight:700;color:#1E293B;margin-bottom:8px;letter-spacing:-.3px;">{{ $hostel->name }}</h4>
                ...
                <div class="d-flex justify-content-between align-items-center pt-3 border-top" style="border-color:#F1F5F9!important;">
                    <a href="{{ route('hostels.show', $hostel) }}" style="font-size:.82rem;color:#4F46E5;text-decoration:none;font-weight:700;display:inline-flex;align-items:center;gap:6px;">View Rooms <i class="fas fa-arrow-right"></i></a>
    ...
    @empty
        <div class="col-12">
            <div style="background:#fff;border:1px solid #E2E8F0;border-radius:18px;padding:60px 20px;text-align:center;color:#64748B;">
                ...
                <h5 class="text-dark fw-bold">No Hostel Blocks Created</h5>
