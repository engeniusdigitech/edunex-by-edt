...
@section('title', 'Add Hostel Block')
@section('content')
<style>
...
.h-sec-hdr{padding:16px 28px;border-bottom:1px solid #F1F5F9;background:#FAFAFA;font-size:.78rem;font-weight:500;color:#475569;text-transform:uppercase;letter-spacing:.8px;}
.h-body{padding:28px;}
...
.btn-save{background:linear-gradient(135deg,#4F46E5,#7C3AED);color:#fff;border:none;padding:12px 28px;border-radius:12px;font-size:.88rem;font-weight:500;display:inline-flex;align-items:center;gap:9px;cursor:pointer;transition:all .2s;box-shadow:0 4px 20px rgba(79,70,229,.3);}
...
<div class="h-form-header">
    <div style="position:relative;z-index:2;display:flex;align-items:center;gap:14px;">
        ...
        <div>
            <div style="font-size:.7rem;font-weight:500;color:#67E8F9;text-transform:uppercase;letter-spacing:1px;margin-bottom:4px;"><i class="fas fa-hotel me-1"></i> Hostels</div>
            <h2 style="font-size:1.4rem;font-weight:500;color:#fff;margin:0;letter-spacing:-.5px;">Add Hostel Block</h2>
        </div>
    </div>
</div>
...
<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="h-card">
            <div class="h-sec-hdr"><i class="fas fa-pen text-primary me-2"></i> Building Details</div>
            <div class="h-body">
                <form action="{{ route('hostels.store') }}" method="POST">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" class="form-control form-control-custom @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="e.g. Boys Hostel A" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="type" class="form-select form-select-custom" required>
                                ...
                                <option value="boys">Boys Block Only</option>
                                <option value="girls">Girls Block Only</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="address" class="form-control form-control-custom" value="{{ old('address') }}" placeholder="e.g. Campus North Wing, Near Sports Complex">
                    </div>

                    <div class="mb-4">
                        <label class="form-label-custom">Description</label>
                        <textarea name="description" class="form-control form-control-custom" rows="3" placeholder="Provide extra block details (optional)...">{{ old('description') }}</textarea>
                    </div>

                    <div class="d-flex align-items-center gap-3">
                        <button type="submit" class="btn-save"><i class="fas fa-save"></i> Save Hostel Block</button>
