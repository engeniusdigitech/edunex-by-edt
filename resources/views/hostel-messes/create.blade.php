...
.m-sec-hdr{padding:16px 28px;border-bottom:1px solid #F1F5F9;background:#FAFAFA;font-size:.78rem;font-weight:500;color:#475569;text-transform:uppercase;letter-spacing:.8px;}
.m-body{padding:28px;}
...
<div class="m-form-header">
    <div style="position:relative;z-index:2;display:flex;align-items:center;gap:14px;">
        ...
        <div>
            <div style="font-size:.7rem;font-weight:500;color:#67E8F9;text-transform:uppercase;letter-spacing:1px;margin-bottom:4px;"><i class="fas fa-utensils me-1"></i> Messes</div>
            <h2 style="font-size:1.4rem;font-weight:500;color:#fff;margin:0;letter-spacing:-.5px;">Create Hostel Mess</h2>
        </div>
    </div>
</div>
