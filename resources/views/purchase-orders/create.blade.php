...
<div class="f-hdr d-flex justify-content-between align-items-center flex-wrap gap-3">
    <div style="position:relative;z-index:2;">
        ...
        <h2 style="font-size:1.5rem;font-weight:500;color:#fff;margin:6px 0 0;letter-spacing:-.5px;">Draft New Purchase Order</h2>
    </div>
    <div style="position:relative;z-index:2;">
    ...
    <div class="col-lg-8">
        <div class="form-card p-4 p-md-5">
            <form action="{{ route('purchase-orders.store') }}" method="POST">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <label for="po_number" class="form-label fw-medium text-dark" style="font-size:.8rem;">PO Number <span class="text-danger">*</span></label>
                        <input type="text" name="po_number" id="po_number" value="{{ old('po_number', $poNumber) }}" class="form-control rounded-3 py-2.5 shadow-none @error('po_number') is-invalid @enderror" style="font-size:.85rem; font-weight:500; color:#4F46E5;" required readonly>
                    ...
                    <div class="col-md-6">
                        <label for="inventory_supplier_id" class="form-label fw-medium text-dark" style="font-size:.8rem;">Select Supplier / Vendor <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-6">
                        <label for="order_date" class="form-label fw-medium text-dark" style="font-size:.8rem;">Requisition / Order Date <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-6">
                        <label for="delivery_date" class="form-label fw-medium text-dark" style="font-size:.8rem;">Expected Delivery Date</label>
