...
<div class="po-hdr d-flex justify-content-between align-items-center flex-wrap gap-3">
    <div style="position:relative;z-index:2;">
        ...
        <h2 style="font-size:1.5rem;font-weight:800;color:#fff;margin:6px 0 0;letter-spacing:-.5px;">Purchase Requisitions</h2>
    </div>
...
<div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
    <form action="{{ route('purchase-orders.index') }}" method="GET" class="row g-3 align-items-end">
        <div class="col-md-5">
            <label for="search" class="form-label small text-muted fw-bold">Search PO Number</label>
        ...
        <div class="col-md-4">
            <label for="status" class="form-label small text-muted fw-bold">Filter Status</label>
        ...
        <table class="table align-middle mb-0">
            ...
            <tbody>
                @forelse($orders as $po)
                    <tr>
                        <td class="ps-4">
                            <a href="{{ route('purchase-orders.show', $po) }}" class="fw-bold text-indigo text-decoration-none" style="font-size:.85rem;">{{ $po->po_number }}</a>
                        </td>
                        <td>
                            <div class="fw-bold text-dark" style="font-size:.85rem;">{{ $po->supplier->name }}</div>
                ...
                @empty
                    <tr>
                        <td colspan="8" class="text-center py-5 text-muted">
                            ...
                            <div class="fw-bold">No Purchase Orders Found</div>
