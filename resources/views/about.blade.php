...
<body>
    ...
    <header class="page-header text-center">
        <div class="container px-4">
            ...
            <p class="text-muted fs-5 mt-4 max-w-2xl mx-auto animate__animated animate__fadeInUp animate__delay-1s" style="max-width: 700px;">
                EduNex is more than just software. It's a commitment to streamlining operations, empowering teachers, and enriching the student experience.
            </p>
        </div>
    </header>
        ...
        <div class="container px-4">
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-6 animate__animated animate__fadeInRight">
                    ...
                    <p class="text-muted mb-4 fs-5">At <strong>Engenius Digitech</strong>, we observed the administrative struggles of hundreds of coaching centers and schools. Manual fee tracking, fragmented attendance logs, and poor student communication were holding educators back.</p>
                    <p class="text-muted mb-4">We decided to build a platform that solves these problems once and for all. EduNex was crafted with a "premium-first" approach — ensuring that enterprise-grade power is accessible to every institute, regardless of size.</p>
            ...
            <div class="row g-4">
                <div class="col-lg-6">
                    <div class="vision-card">
                        ...
                        <p class="text-muted mb-0 fs-5 lh-base">To be the global gold standard for educational operations, where technology acts as a silent partner in the classroom, letting teachers focus entirely on teaching.</p>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="vision-card">
                        ...
                        <p class="text-muted mb-0 fs-5 lh-base">To simplify institute management through beautiful design and powerful automation, making administrative excellence achievable for every educator on the planet.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container px-4 py-5">
            <div class="row g-5">
                <div class="col-lg-5">
                    ...
                    <p class="text-muted mb-5">Our principles are the foundation of everything we build. We don't just ship code; we ship solutions that matter.</p>
                    
                    <div class="value-item">
                        <div class="value-icon"><i class="fas fa-heart"></i></div>
                        <div>
                            <h5 class="fw-bold">Empathy for Educators</h5>
                            <p class="text-muted small">We listen to the daily struggles of teachers and owners to build features that actualy save time.</p>
                        </div>
                    </div>
                    <div class="value-item">
                        ...
                        <div>
                            ...
                            <p class="text-muted small">We treat your institute's data with the same level of security as financial institutions do.</p>
                        </div>
                    </div>
                    <div class="value-item">
                        ...
                        <div>
                            ...
                            <p class="text-muted small">We're never "done." We continuously push updates to make EduNex faster and more capable.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-7">
                    <div class="brand-focus animate__animated animate__fadeIn">
                        <img src="{{ asset('images/logo.png') }}" alt="EduNex" style="height: 50px; filter: brightness(0) invert(1);" class="mb-4">
                        ...
                        <a href="https://engeniusdigitech.netlify.app/" target="_blank" class="btn btn-light btn-modern fw-bold px-4">
    ...
    <section class="py-5">
        <div class="container px-4 py-5 text-center">
            ...
            <p class="text-muted mb-5 mx-auto" style="max-width: 500px;">Experience the easiest way to manage your students, staff, and finances in one place.</p>
            <a href="{{ route('pricing') }}" class="btn btn-primary-glow btn-modern px-5 py-3">View Pricing Plans <i class="fas fa-arrow-right ms-2"></i></a>
        </div>
    </section>
