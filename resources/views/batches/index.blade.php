    ...
    <div class="d-flex gap-2">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                ...
                <li>
                    <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#importBatchesModal">
                ...
                <li>
                    <a class="dropdown-item" href="{{ asset('samples/batches-sample.csv') }}" download>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-4 border-0 shadow">
            <div class="modal-header border-bottom-0 pb-0">
                <div>
                    <h5 class="modal-title fw-semibold" id="importBatchesModalLabel">
                        <i class="fas fa-file-import text-primary me-2"></i> Import Batches
                    </h5>
                    <p class="text-muted small mb-0 mt-1">Upload an Excel or CSV file to bulk-import batches.</p>
                </div>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('batches.import') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body pt-3">
                    ...
                    <div class="mb-3">
                        <label for="batches_import_file" class="form-label fw-medium">Select File <span class="text-danger">*</span></label>
                        <input type="file" class="form-control" id="batches_import_file" name="import_file" accept=".xlsx,.xls,.csv" required>
                        <div class="form-text">Accepted formats: .xlsx, .xls, .csv (max 5 MB)</div>
                    </div>
                    <a href="{{ asset('samples/batches-sample.csv') }}" download class="btn btn-sm btn-outline-secondary">
