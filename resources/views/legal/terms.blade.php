...
<head>
    ...
    <x-seo title="Terms and Conditions | EduNex ERP Institute and School Management System" description="Review the terms and conditions for using the EduNex ERP Institute and School Management platform." />
        ...
        <div class="row justify-content-center">
            <div class="col-lg-9">
                <div class="legal-content">
                    <p>By accessing or using the <strong>EduNex ERP</strong> platform, you agree to be bound by these Terms and Conditions. Please read them carefully.</p>

                    <h2>1. Service Provision</h2>
                    <p>EduNex ERP provides a SaaS-based Institute and School Management system. We strive for 99.9% uptime but do not guarantee uninterrupted service due to maintenance or external factors.</p>
                    ...
                    <p>All software, design, and content on the EduNex ERP platform (excluding user-uploaded data) are the exclusive property of Engenius Digitech.</p>
