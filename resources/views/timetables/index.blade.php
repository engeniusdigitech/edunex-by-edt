            ...
            <div class="card-body p-4">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
                    <form action="{{ route('timetables.index') }}" method="GET" class="d-flex align-items-center gap-2 m-0 flex-grow-1" id="batchFilterForm">
                        <label class="fw-medium text-secondary text-nowrap mb-0 small">SELECT BATCH:</label>
                ...
                <div class="col-xl col-lg-4 col-md-6">
                    <div class="card border-0 shadow-sm rounded-4 h-100 overflow-hidden">
                        <div class="card-header bg-primary py-3 border-0 text-center">
                            <h6 class="mb-0 fw-medium text-white text-uppercase letter-spacing-1">{{ $dayName }}</h6>
                        </div>
                            ...
                            @forelse($daySlots as $slot)
                                <div class="bg-white border rounded-4 p-3 mb-3 shadow-sm hover-translate transition-all">
                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                        <h6 class="fw-medium text-primary mb-0 small">{{ $slot->subject->name }}</h6>
                                        @if(auth()->user()->isInstituteAdmin() || auth()->user()->isPrincipal() || auth()->user()->isSuperAdmin())
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 rounded-4 shadow-lg">
            <div class="modal-header border-0 pb-0">
                <h5 class="modal-title fw-medium">Add Timetable Slot</h5>
            ...
            <form action="{{ route('timetables.store') }}" method="POST">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="mb-3">
                        <label class="form-label small fw-medium">Teacher</label>
                    ...
                    <div class="row g-3">
                        <div class="col-6">
                            <label class="form-label small fw-medium">Day</label>
