        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-body p-4 p-md-5">
                    <form action="{{ route('live-lectures.update', $liveLecture) }}" method="POST"
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <select name="batch_id"
                                    class="form-select border-0 bg-light py-2 @error('batch_id') is-invalid @enderror"
                                    required>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="subject"
                                    class="form-select border-0 bg-light py-2 @error('subject') is-invalid @enderror"
                                    required>
                                    <option value="">Select Subject</option>
                                    @foreach($subjects as $subject)
                                        <option value="{{ $subject->name }}" data-batch="{{ $subject->batch_id }}" {{ (old('subject') ?? $liveLecture->subject) == $subject->name ? 'selected' : '' }}>
                                            {{ $subject->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="title"
                                    class="form-control border-0 bg-light py-2 @error('title') is-invalid @enderror"
                                    value="{{ old('title') ?? $liveLecture->title }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="recorded_at"
                                    class="form-control border-0 bg-light py-2 @error('recorded_at') is-invalid @enderror"
                                    value="{{ old('recorded_at') ?? $liveLecture->recorded_at->format('Y-m-d') }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="file" name="video_file" accept="video/mp4,video/quicktime,video/x-msvideo"
                                    class="form-control border-0 bg-light py-2 @error('video_file') is-invalid @enderror">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description" rows="3"
                                    class="form-control border-0 bg-light py-2 @error('description') is-invalid @enderror">{{ old('description') ?? $liveLecture->description }}</textarea>
