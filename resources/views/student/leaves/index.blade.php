...
<head>
    ...
    <style>
        ...
        .leave-type { font-weight: 500; font-size: 1rem; color: var(--text); }
                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="leave-date">
                                ...
                                <span class="fw-medium" style="color: var(--primary-blue);">{{ $leave->start_date->diffInDays($leave->end_date) + 1 }} Days</span>
                            </div>
                        </div>
                        <div class="d-flex align-items-center gap-3">
