...
<body>
    ...
    <!-- Header -->
    <div class="header">
        <div class="institute">{{ $student->institute->name ?? 'EduNex ERP' }} &mdash; Student Report</div>
        <h1>{{ $student->name }}</h1>
        <div class="meta">
    ...
    <div class="footer">Generated by EduNex ERP &bull; {{ $student->institute->name ?? '' }} &bull; Confidential</div>
