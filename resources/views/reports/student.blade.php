...
<div class="card border-0 mb-4" style="background: linear-gradient(135deg, #2563EB, #0D9488 60%, #10B981); border-radius: 18px; overflow: hidden;">
    <div class="card-body p-4 d-flex align-items-center gap-4" style="position:relative;">
        {{-- Avatar --}}
        <div class="d-flex align-items-center justify-content-center fw-medium text-white flex-shrink-0"
        ...
        <div>
            <h4 class="fw-medium text-white mb-1">{{ $student->name }}</h4>
    ...
    <div class="col-lg-5">
        <div class="card border-0 shadow-sm" style="border-radius:16px;">
            <div class="card-header bg-white border-bottom-0 pt-4 px-4 pb-0">
                <h6 class="fw-medium text-dark text-uppercase mb-0" style="letter-spacing:1px;font-size:0.78rem;">
            ...
            <div class="card-body p-0" style="max-height:520px;overflow-y:auto;">
                ...
                <div class="px-4 py-2" style="background:#F8FAFC;border-top:1px solid #F1F5F9;border-bottom:1px solid #F1F5F9;">
                    <span class="fw-medium text-muted small text-uppercase" style="letter-spacing:1px;font-size:0.72rem;">
    ...
    <div class="col-lg-7">
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="py-3">
                                    @if($score)
                                        <span class="fw-medium text-primary">{{ $score->score }}</span>
        ...
        <div class="card border-0 shadow-sm" style="border-radius:16px;">
            <div class="card-header bg-white border-bottom-0 pt-4 px-4 pb-2 d-flex justify-content-between align-items-center">
                ...
                <span class="fw-medium text-success" style="font-size:0.9rem;">₹{{ number_format($totalPaid, 2) }} total</span>
            </div>
            <div class="card-body p-0">
                @if($payments->isEmpty())
