...
<body class="antialiased">
    ...
    <div class="page-header text-center">
        <div class="container">
            <h1 class="page-title animate__animated animate__fadeInUp">Start Your Trial</h1>
            <p class="fs-5 text-muted max-w-2xl mx-auto animate__animated animate__fadeInUp animate__delay-1s" style="max-width: 700px;">
                Ready to upgrade your workflow? Fill the form below, and our team will get your institute set up.
            </p>
        </div>
    </div>
